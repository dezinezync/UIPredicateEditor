...
public extension NSPredicate {
  ...
  func localizedString(using formattingHelper: FormattingDictionaryHelper?) -> String {
  ...
  func localizedAttributedString(
    ...
    guard let formattingHelper else {
      return NSAttributedString(string: localizedFormat)
    }
    ...
    if let compound = self as? NSCompoundPredicate {
      ...
      for (index, attr) in subpredicates.enumerated() {
