...
@available(iOS 18, macCatalyst 18, *)
public final class FormattingDictionaryHelper {
  ...
  func firstKeyMatch(for partialKey: String) -> (key: String, value: String)? {
  ...
  /// - Returns: (key,value) tuple if a partial match was found
  func firstValueMatch(for partialValue: String) -> (key: String, value: String)? {
